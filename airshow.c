...
void front()
{
        ...
        output(365,130," GOGTE INSTITUTE OF TECHNOLOGY",fonts[3]);
        ...
        glColor3f(0.3,0.5,0.8);
        output(225,450,"Akshay Iyer",fonts[3]);
        output(670,450,"Akshay Kanagali",fonts[3]);
        output(180,300,"",fonts[3]);
        output(220,400,"(2GI13CS007)",fonts[0]);
        output(680,400,"(2GI13CS009)",fonts[0]);
...
TRANSLATION <=",fonts[3]);
        output(180,520,"=> LEFT CLICK MOUSE FOR ROTATION TRANSLATION
<=",fonts[3]);
